...
const TeachersPage = () => {
  ...
  const categoryProducts = useMemo(() => allProducts.filter(p => p.category === 'teachers'), [allProducts]);
  ...
  return (
    <Layout>
      <div className="bg-teachers py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold text-primary-foreground mb-4">Teachers Collection</h1>
          <p className="text-primary-foreground/90 max-w-2xl mx-auto">
            Professional attire designed for faculty members of Medicaps University
          </p>
        </div>
      </div>
