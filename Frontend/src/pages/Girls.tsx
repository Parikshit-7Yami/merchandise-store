...
const GirlsPage = () => {
  ...
  const categoryProducts = useMemo(() => allProducts.filter(p => p.category === 'girls'), [allProducts]);
  ...
  return (
    <Layout>
      <div className="bg-girls py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold text-primary-foreground mb-4">Girls Collection</h1>
          <p className="text-primary-foreground/90 max-w-2xl mx-auto">
            Explore our collection of trendy and comfortable merchandise for female students
          </p>
        </div>
      </div>
