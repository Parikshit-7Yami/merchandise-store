...
export const eventCollections: EventCollection[] = [
  {
    ...
    image: 'https://www.medicaps.ac.in/uploads/events/aagaaz-2026.webp',
  ...
  },
  {
    ...
    image: 'https://www.medicaps.ac.in/uploads/events/hpl-2.webp',
  ...
  },
  {
    ...
    image: 'https://www.medicaps.ac.in/uploads/events/convocation1.webp',
...
export const eventProducts: Product[] = [
  ...
  {
    id: 'freshers-formal-shirt',
    name: 'Formal Induction Shirt',
    price: 899,
    image: '/products/formal_freshers_shirt_girls_1777470963180.png',
    category: 'girls',
    subcategory: 'Formal Shirts',
    fabric: 'Oxford Cotton',
    colors: ['#FFFFFF', '#87CEEB', '#1a237e'],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description: 'Professional button-down shirt for formal induction and university events.',
    eventName: 'Freshers 2026',
    isEventMerch: true
  },
  // Hackathon
  ...
  },
  {
    ...
    price: 999,
    image: '/products/womens_sports_jersey_formal_1777471000767.png',
    category: 'girls',
    subcategory: 'Sports T-shirts',
    fabric: 'Performance Dri-Fit',
    colors: ['#1a237e', '#8B1538', '#FFFFFF'],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    description: 'Premium official women\'s sports jersey for athletic meets and team events.',
    eventName: 'Sports Meet 2026',
    isEventMerch: true
  },
  // Farewell
